...
<head>
    ...
    <title><?=isset($title) ? $title : 'Webgis Gizi Balita'?></title>
    ...
    <!-- Tambahkan baris-baris ini untuk menyertakan Bootstrap CSS dan JS -->
    ...
    <link rel="stylesheet" href="<?=templates()?>/extensions/datatables.net-bs5/css/dataTables.bootstrap5.min.css">
    ...
    <link rel="stylesheet" crossorigin href="<?=templates()?>/compiled/css/iconly.css">
